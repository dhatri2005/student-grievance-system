...
<body background="img/reg.jpg">
    ...
    <h2 class="py-3 px-5" style="margin-left: 200px;">Student Register</h2>

    <div class="container px-5 my-5">
        <form action="registerdata_student.php" method="POST">
            ...
            <div class="form-floating mb-3">
                <input class="form-control" name="idNumber" type="number" placeholder="Student ID" required style="width: 350px;" />
